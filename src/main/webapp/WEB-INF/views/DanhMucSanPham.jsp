...
<div class="d-flex justify-content-center mt-3">
    <div class="col-md-8 account-info" style="background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1); height: 600px;">
        ...
        <form action="${pageContext.request.contextPath}/danh-muc/save" method="post">
    ...
    <table class="table" style="background-color: #fff; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        ...
        <c:forEach var="dm" items="${listDM}">
            <tr>
                ...
                <td>${dm.ngaySua}</td>
                <td>
                    <a href="${pageContext.request.contextPath}/danh-muc/edit/${dm.id}" class="btn btn-primary btn-sm">Sửa</a>
                    <a href="${pageContext.request.contextPath}/danh-muc/delete/${dm.id}" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc muốn xóa danh mục này?');">Xóa</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
